...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="<?=base_url('koleksi')?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-book"></i>
          <div>Koleksi</div>
        </a>
      </li>
      ...
      <li class="menu-item">
        <a href="<?=base_url('laporan_pengembalian')?>" class="menu-link">
          <i class="menu-icon tf-icons bx bx-book"></i>
          <div>Laporan Pengembalian</div>
        </a>
      </li>
      <li class="menu-header small text-uppercase">
      ...
      <li class="menu-item">
        <a href="<?=base_url('login/log_out')?>" class="menu-link">
